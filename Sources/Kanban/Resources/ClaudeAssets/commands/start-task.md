...
[impact-analysis methodology](../skills/impact-analysis/methodology.md)
...
0. **Historische Ticket-Verfolgung (PFLICHT, vor allem anderen):** Für jede geplant zu ändernde
   ...
   **Wenn ein altes Ticket eine Heuristik/Anforderung etabliert hat, die mit deinem Plan kollidiert,
   ...
   in [impact-analysis methodology](../skills/impact-analysis/methodology.md) → „Schritt 0“.
...
- [ ] JIRA Lösungsfeld ausgefüllt (beide Abschnitte)
